  ...
  const userApi = () => {
    ...
    axios(token)
      .post('/search', {
        ...
        ageFrom: route.params
          ? route.params.ageFrom
          : profile.partnerpref.ageFrom,
        country: route.params
          ? route.params.country
          : profile.partnerpref.country,
        marital: route.params
          ? route.params.marital
      ...
      .then(resp => {
        if (resp.data.data.length === 0 && data.length === 0) {
          ...
          Alert.alert(
            'Message',
            'No matching profiles found. Please update your partner preferences.',
          );
        }
            ...
            renderItem={data => {
              return (
                <ProfileComp
                  ...
                  onPressProfile={() =>
                    navigation.navigate('otherprofile', {data: data.item})
                  }
                />
              );
            }}
