...
import { View, Text, ScrollView, Modal, TouchableOpacity, TouchableWithoutFeedback } from 'react-native';
...
const SkinConditionModal = ({ state, onPress, onPressCancel, array }) => {
  const arr = []
  return (
  ...
  return (
    <>
      <SafeAreaView style={[Theme.height100p]}>
        ...
        />
        <SkinConditionModal state={skinCondition} array={array} onPressCancel={() => SetSkinCondition(!skinCondition)} />
        <ScrollView style={[]}>
          <View style={[Theme.width100p]}>
            <View style={[Theme.selectedItems, Theme.padding10]}>
              ...
              <DropDownButton title="Skin Condition" onPress={() => SetSkinCondition(!skinCondition)} />
