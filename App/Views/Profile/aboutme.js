    ...
    return (
        <>
            <SafeAreaView style={[Theme.height100p]}>
                <Header title="About me" left="arrowleft" leftnav={() => navigation.goBack()} />
                <ScrollView style={[Theme.flexGrow, Theme.selectedItems]}>
                    <View style={[Theme.flex1, Theme.width100p]}>
                        <View style={[Theme.flex1, Theme.padding10]}>
                            ...
                            <Text style={[Theme.textBody, Theme.paddingHorizonal10p, Theme.purple]}>Keep it clean. Do not mention your contact details , social media profile , web links here.</Text>
                        </View>
                    </View>
                </ScrollView>
            </SafeAreaView>
